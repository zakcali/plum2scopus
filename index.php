...
Dergi ismi: <input type="text" name="Title" size="50"  id="Title" value="<?php echo $s->dergi;?>"> 
...
<br/>
Özet <br/>
<textarea rows = "20" cols = "90" name = "ozet" id="ozetAlan"><?php echo $s->AbstractText;?></textarea>  <br/>
<script>
